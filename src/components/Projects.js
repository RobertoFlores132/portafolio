    ...
    return (
        <div className='projectcontainer'>
            ...
            <div className='proyect-image2'>
                <img className='Proyect2' src={Project2} alt="Weather App" />
            </div>
            
            </div>
            <div className='descriptioncontainer'>
            <div className='proyect-image1'>
                <img className='Proyect1' src={Project3} alt="Gym app" />
            </div>
            <div className='proyect-description'>
                <h3>Gym Page</h3>
            ...
            <div className='proyect-button'>
            <a className='button1' href='https://amazing-sprite-fa04df.netlify.app' target="_blank" rel="noopener noreferrer" >Visitar Sitio</a>
            <a className='button1' href='https://github.com/RobertoFlores132/gymapp' target="_blank" rel="noopener noreferrer" >Ver repositorio</a>
            </div>
            </div>
